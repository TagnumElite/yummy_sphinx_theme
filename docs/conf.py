...
# -*- coding: utf-8 -*-
#
# niftools_sphinx_theme documentation build configuration file, created by
...
project = 'yummy_sphinx_theme'
copyright = '2017, TagnumElite'
author = 'TagnumElite'
...
html_theme_path = [os.path.join(os.path.dirname(os.path.dirname(__file__)))]
